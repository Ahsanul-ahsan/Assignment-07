...
const CardDetails = () => {
    ...
    const { name, days_since_contact, tags, status, picture, email, bio, goal, next_due_date } = expectCard;

    const handelClick = (expectCard,actionType) => {
                ...
                <div className="bg-white shadow rounded-xl p-6 text-center cursor-pointer">
                    ...
                    <div>
                        ...
                        <div className="">
                            ...
                            <p className="font-semibold border-t border-gray-300 ">
                                Bio : <span className="text-gray-400 text-[14px]"> {bio}</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="md:col-span-2 space-y-4">
                ...
                <div className="bg-white p-4 rounded shadow">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <button onClick={() => handelClick(expectCard,"call")} className="flex flex-col items-center p-3 border rounded hover:bg-gray-100">
                            <FiPhone size={20} />
                            <span className="text-xs mt-1">Call</span>
                        </button>

                        <button onClick={() => handelClick(expectCard,"text")} className="flex flex-col items-center p-3 border rounded hover:bg-gray-100">
                            <FiMessageSquare size={20} />
                            <span className="text-xs mt-1">Text</span>
                        </button>

                        <button onClick={() => handelClick(expectCard,"video")} className="flex flex-col items-center p-3 border rounded hover:bg-gray-100">
                            <FiVideo size={20} />
